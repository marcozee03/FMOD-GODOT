...
loads ``bank_name`` into memory. ``bank_name`` can be a file path or a "bank:/<bank_name>" path.
                                ...
                                **Note:** For banks in the "bank:/" path to be found. Go to ** Project > Project Settings > Fmod > Banks ** and set ``Bank Directory`` to the directory banks are a stored in your project.
