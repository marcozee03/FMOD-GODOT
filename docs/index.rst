...
.. note::
    ...
    Fmod is a commercial library. This is an Unofficial integration with the godot engine. Check `Licensing`_ for more info. For official downloads of the library files check `Downloads`_
