...
{
    stream << "Is3D:" << object.is3d << " Doppler:" << object.doppler_enabled << " Length:" << object.lengthMS
           << " one_shot:" << object.one_shot << " min:" << object.min << " max:" << object.max;
...
{
    stream << '[' << object.min_value << ".." << object.default_value << ".." << object.max_value
