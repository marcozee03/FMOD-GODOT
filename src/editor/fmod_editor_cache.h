...
class FmodEditorCache
{
  ...
  private:
    ...
    PathTree<Studio::Bank::Cache> bank_cache;
  ...
  public:
    ...
    void add(const Studio::Bank::Cache &p_bank);
    ...
    const PathTree<Studio::Bank::Cache> get_bank_cache() const;
    ...
    Studio::Bank::Cache get_bank(const String &p_path) const;
