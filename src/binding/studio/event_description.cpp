...
#ifdef TOOLS_ENABLED
FmodGodot::Studio::EventDescription::Cache::Cache(FMOD_STUDIO_EVENTDESCRIPTION *p_description)
{
...
#endif
void FmodGodot::Studio::EventDescription::_bind_methods()
{
...
bool FmodGodot::Studio::EventDescription::is_valid(size_t p_handle)
{
    return FMOD_Studio_EventDescription_IsValid((FMOD_STUDIO_EVENTDESCRIPTION *)p_handle);
}
godot::Vector4i FmodGodot::Studio::EventDescription::get_id(size_t p_handle)
{
    FMOD_GUID guid;
    FMOD_Studio_EventDescription_GetID((FMOD_STUDIO_EVENTDESCRIPTION *)p_handle, &guid);
    return FmodGodot::cast_to_vector4i(guid);
}
String FmodGodot::Studio::EventDescription::get_path(size_t p_handle)
{
    FMOD_GET_STRING(FMOD_Studio_EventDescription_GetPath, (FMOD_STUDIO_EVENTDESCRIPTION *)p_handle, path);
    return path;
}
int FmodGodot::Studio::EventDescription::get_parameter_description_count(size_t p_handle)
{
    int count;
    FMOD_Studio_EventDescription_GetParameterDescriptionCount((FMOD_STUDIO_EVENTDESCRIPTION *)p_handle, &count);
    return count;
}
FMOD_STUDIO_PARAMETER_DESCRIPTION FmodGodot::Studio::EventDescription::getParameterDescriptionByIndex(size_t p_handle,
                                                                                                      int p_index)
{
...
FMOD_STUDIO_PARAMETER_DESCRIPTION FmodGodot::Studio::EventDescription::getParameterDescriptionByName(
    size_t p_handle, const String &p_name)
{
    FMOD_STUDIO_PARAMETER_DESCRIPTION parameter;
...
FMOD_STUDIO_PARAMETER_DESCRIPTION FmodGodot::Studio::EventDescription::getParameterDescriptionByID(size_t p_handle,
                                                                                                   uint64_t p_id)
{
    FMOD_STUDIO_PARAMETER_DESCRIPTION parameter;
...
godot::String FmodGodot::Studio::EventDescription::get_parameter_label_by_index(size_t p_handle, int p_index,
                                                                                int p_labelindex)
{
...
godot::String FmodGodot::Studio::EventDescription::get_parameter_label_by_name(size_t p_handle, const String &p_name,
                                                                               int p_labelindex)
{
...
godot::String FmodGodot::Studio::EventDescription::get_parameter_label_by_id(size_t p_handle, uint64_t p_id,
                                                                             int p_labelindex)
{
...
int FmodGodot::Studio::EventDescription::get_user_property_count(size_t p_handle)
{
    int count;
    FMOD_Studio_EventDescription_GetUserPropertyCount((FMOD_STUDIO_EVENTDESCRIPTION *)p_handle, &count);
    return count;
}
godot::Variant FmodGodot::Studio::EventDescription::get_user_property_by_index(size_t p_handle, int p_index)
{
...
godot::Variant FmodGodot::Studio::EventDescription::get_user_property(size_t p_handle, const String &p_name)
{
    FMOD_STUDIO_USER_PROPERTY property;
...
FMOD_RESULT FmodGodot::Studio::EventDescription::load_sample_data(size_t p_handle)
{
    return FMOD_Studio_EventDescription_LoadSampleData((FMOD_STUDIO_EVENTDESCRIPTION *)p_handle);
}
FMOD_RESULT FmodGodot::Studio::EventDescription::unload_sample_data(size_t p_handle)
{
    return FMOD_Studio_EventDescription_UnloadSampleData((FMOD_STUDIO_EVENTDESCRIPTION *)p_handle);
}
FMOD_STUDIO_LOADING_STATE FmodGodot::Studio::EventDescription::get_sample_loading_state(size_t p_handle)
{
    FMOD_STUDIO_LOADING_STATE state;
    FMOD_Studio_EventDescription_GetSampleLoadingState((FMOD_STUDIO_EVENTDESCRIPTION *)p_handle, &state);
    return state;
}
FMOD_RESULT FmodGodot::Studio::EventDescription::release_all_instances(size_t p_handle)
{
    return FMOD_Studio_EventDescription_ReleaseAllInstances((FMOD_STUDIO_EVENTDESCRIPTION *)p_handle);
}
void *FmodGodot::Studio::EventDescription::get_user_data(size_t p_handle)
{
    void *userdata;
    FMOD_Studio_EventDescription_GetUserData((FMOD_STUDIO_EVENTDESCRIPTION *)p_handle, &userdata);
    return userdata;
}
FMOD_RESULT FmodGodot::Studio::EventDescription::set_user_data(size_t p_handle, void *p_userdata)
{
