...
unsigned int FmodGodot::Studio::Bus::get_inclusive_c_p_u_usage(Handle p_handle)
{
    unsigned int usage;
    FMOD_Studio_Bus_GetCPUUsage(std::bit_cast<FMOD_STUDIO_BUS *>(p_handle), nullptr, &usage);
    return usage;
}
unsigned int FmodGodot::Studio::Bus::get_exclusive_c_p_u_usage(Handle p_handle)
{
    unsigned int usage;
